        ...
        try:
            if interaction.user.id != self.author.id:
                await interaction.response.send_message(
                    "Sorry Bro, This is not your interaction.", ephemeral=True
                )
                return
            ...
            if selected_values and "music" in selected_values:
                embed = discord.Embed(
                    colour=Fluffy.color,
                    description="`Play`, `Pause`, `Resume`, `Stop`, `Queue`, `Volume`, `Skip`, `ClearQueue`, `DefaultVolume`, `Move`, `Join`, `Leave`, `NowPlaying`, `Forward`, `Rewind`, `Seek`, `Remove`",
                )
                ...
                embed = discord.Embed(
                    colour=Fluffy.color,
                    description="`Avatar`, `Banner`, `MemberCount`, `Afk`",
                )
                ...
                embed = discord.Embed(
                    colour=Fluffy.color,
                    description="`Vaporwave`, `Lofi`, `8d`, `Slowmo`, `BassBoost`, `China`, `Chipmunk`, `DarthVader`, `Demon`, `Funny`, `Karoke`, `NightCore`, `Pop`, `Soft`, `TrebleBass`, `Tremolo`, `Alien`, `Reset`",
                )
                ...
                embed = discord.Embed(
                    colour=Fluffy.color,
                    description="`Ping`, `Purge`, `Uptime`, `Invite`, `Support`, `Stats`, `Setpreifx`, `Help`",
                )
...
class Help(commands.Cog):
    ...
    async def help(self, ctx, *, query=None):
        ...
        embed = discord.Embed(
            colour=Fluffy.color,
            description=f"{dot} My prefix for this server is `{prefix}`\n{dot} Total Commands `45`\n{dot} [**Fluffy**]({Fluffy.bot_link}) | [**Support**]({Fluffy.support_link})\n{dot} Thanks for using Fluffy",
        )

        embed.add_field(
            name="Music",
            value="`Play`, `Pause`, `Resume`, `Stop`, `Queue`, `Volume`, `Skip`, `ClearQueue`, `DefaultVolume`, `Move`, `Join`, `Leave`, `NowPlaying`, `Forward`, `Rewind`, `Seek`, `Remove`",
            inline=False,
        )
        embed.add_field(
            name="Filters",
            value="`Vaporwave`, `Lofi`, `8d`, `Slowmo`, `BassBoost`, `China`, `Chipmunk`, `DarthVader`, `Demon`, `Funny`, `Karaoke`, `NightCore`, `Pop`, `Soft`, `TrebleBass`, `Tremolo`, `Alien`, `Reset`",
            inline=False,
        )
        embed.add_field(
            name="Utility",
            value="`Avatar`, `Banner`, `MemberCount`, `Afk`",
            inline=False,
        )
        embed.add_field(
            name="Info",
            value="`Ping`, `Purge`, `Uptime`, `Invite`, `Support`, `Stats`, `Setprefix`, `Help`",
            inline=False,
        )
        ...
        if query:
            ...
            if command:
                ...
                ryze = discord.Embed(
                    color=Fluffy.color, description=f"**{command.help}**"
                )
